const JornalForm = () => {
  return (
    <div className="flex w-full sm:w-[90%] md:w-[70%] xl:w-[40%]">
      ...
      <button type="button" className="align-middle text-white text-sm font-semibold leading-3 py-2 px-4 sm:px-5 whitespace-nowrap bg-[#088178] rounded rounded-tl-none rounded-bl-none normal">Inscreva-se</button>
    </div>
  );
}
